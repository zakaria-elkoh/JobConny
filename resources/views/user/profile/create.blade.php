...
<form class="p-6 bg-[#333] max-w-screen-md mx-auto mt-32 mb-10 rounded-3xl" action={{route('users.store')}} method="POST">
    @csrf
    <h2 class="text-3xl font-extrabold mb-5 text-center dark:text-white">Create My Profile:</h2>
    <div>
    ...
    <div>
        ...
        <input type="text" name="job_name" value="{{old('job_name')}}" id="job_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="job_name">
        @error('job_name')
            <span class="text-red-400">{{$message}}</span>
        @enderror
    </div>
    <div>
        ...
        <input type="text" name="experience" value="{{old('experience')}}" id="experience" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Experience">
        @error('experience')
            <span class="text-red-400">{{$message}}</span>
        @enderror
    </div>
    ...
    <button type="submit" name="create_profile" class="text-white block mx-auto bg-blue-700 focus:outline-none hover:bg-blue-800 focus:ring-4 font-medium rounded-full text-sm py-2.5 px-10 mt-12">Create my profile</button>
</form>